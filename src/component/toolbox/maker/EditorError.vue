<template>
  <div v-if="ready" style="height: 100%" class="pdlr-10">
    ...
    <div class="pdtb-5 ft-13">
      <span class="color-grey">错误列表</span>
    ...
    <el-table
      ...
      size="mini"
    >
      <el-table-column label="错误名称" fixed width="220">
      ...
      <el-table-column label="错误码">
        <template slot-scope="scope">
          <div class="">
            <el-input v-model="scope.row.code" type="text" />
          </div>
        </template>
      </el-table-column>
      <el-table-column label="错误信息">
        <template slot-scope="scope">
          <div class="">
            <el-input v-model="scope.row.msg" type="text" />
          </div>
        </template>
      </el-table-column>
